...
class Solver(object):
    ...
    def generate(self, num_sample=100, target=-1, epsilon=0.03, alpha=2/255, iteration=1):
        ...
        save_image(x_true,
                   self.output_dir.joinpath('legitimate(t_{},e_{},i_{}).jpg'.format(target,
                                                                                    epsilon,
                                                                                    iteration)),
                   nrow=10,
                   padding=2,
        ...
        save_image(x_adv,
                   self.output_dir.joinpath('perturbed(t_{},e_{},i_{}).jpg'.format(target,
                                                                                   epsilon,
                                                                                   iteration)),
                   nrow=10,
                   padding=2,
                   pad_value=0.5)
        save_image(changed,
                   self.output_dir.joinpath('changed(t_{},e_{},i_{}).jpg'.format(target,
                                                                                 epsilon,
                                                                                 iteration)),
                   nrow=10,
                   padding=3,
